...
const Summary = () => {
  ...
  <div className="card-body items-center text-center">
    <h2 className="card-title font-bold text-6xl">100+</h2>
...
<p ><MdRateReview className='h-24 text-9xl'></MdRateReview></p>
  ...
  <div className="card-body items-center text-center">
    <h2 className="card-title font-bold text-6xl">200+</h2>
  ...
  <div className="card-body items-center text-center">
    <h2 className="card-title font-bold text-6xl">50+</h2>
    <p className='text-2xl text-purple-600'>Tools</p>
  
  </div>
</div>
            </div>
            <div className='bg-info text-3xl mt-5 h-44 text-center rounded mx-auto'>
